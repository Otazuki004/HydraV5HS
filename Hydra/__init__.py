...
if ENV:
    ...
    from Hydra.config import Development as Config
...
telegraph = Telegraph()
print("[Hydra]: Telegraph Account Creating")
telegraph.create_account(short_name="Hydra")
updater = tg.Updater(
    token=TOKEN,
    workers=WORKERS,
...
print("[Hydra]: TELETHON CLIENT STARTING")
...
# ------------------------------------------------------------------
print("[Hydra]: PYROGRAM CLIENT STARTING")
...
from Hydra.modules.helper_funcs.handlers import (
...
print ("Successfully Installed V-5")
