...
from Hydra.modules import ALL_MODULES
from Hydra.modules.helper_funcs.chat_status import is_user_admin
from Hydra.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
────「 [{}](https://te.legra.ph/file/95af77fcdf411cd9a7846.jpg) 」────
*ʜᴇʟʟᴏ! {},*
*ɪ ᴀᴍ ᴀ Mᴏsᴛ Pᴏᴡᴇʀғᴜʟʟ Tᴇʟᴇɢʀᴀᴍ ʙᴏᴛ.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
❍ *Uptime:* `{}`
❍ `{}` *Users, Across* `{}` *Chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
GROUP_START_IMG = (
    ...
    "https://te.legra.ph/file/2bc22351178c1e233679d.mp4",
    "https://te.legra.ph/file/15ed4120a11e8f43fe7ce.mp4",
    "https://te.legra.ph/file/6278368ade92bd9bce8f8.mp4",
    "https://t.me/ghffg_67d/4",
    "https://t.me/ghffg_67d/3",
)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module(f"Hydra.modules.{module_name}")
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="[► Support ◄]",
                            url=f"https://telegram.dog/FutureCity005",
                        ),
                        InlineKeyboardButton(
                            text="📢 Updates",
...
# note it's beta some errors available 
    if len(message) >= 4096:
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            ...
                            InlineKeyboardButton(
                                text="[► Support ◄]", url=f"https://t.me/FutureCity005"
                            ),
                        ]
                    ]
                ),
...
def donate(update: Update, context: CallbackContext) -> None:
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1985665341 and DONATION_LINK:
            update.effective_message.reply_text(
